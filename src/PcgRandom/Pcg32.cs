/*
 * PCG Random Number Generation for .net.
 *
 * Copyright 2016 Jukka Teittinen
...
namespace PcgRandom
{
    ...
    public class Pcg32 : Random
    {
        ...
        /// <returns>A 32-bit signed integer greater than or equal to minValue and less than maxValue; that is, the range of return values includes minValue
